...
public class GetContactsAction implements Action {
    ...
    private static final int CONTACTS_AMOUNT_ON_PAGE = 10;
    public String execute(HttpServletRequest request) throws ActionException {
        ...
        try {
            List<Contact> contactList = contactService.getContactList((page - 1) * CONTACTS_AMOUNT_ON_PAGE + 1, CONTACTS_AMOUNT_ON_PAGE, sortCondition);
